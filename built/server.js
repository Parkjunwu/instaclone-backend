...
var apollo = new apollo_server_express_1.ApolloServer({
    ...
    context: function (context) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!context.req) return [3 /*break*/, 2];
                    _a = {};
                    return [4 /*yield*/, (0, user_utils_1.getUser)(context.req.headers.token)];
                ...
                case 2:
                    ...
                    return [2 /*return*/, { loggedInUser: loggedInUser }];
            }
        });
    }); },
    subscriptions: {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = {};
                            return [4 /*yield*/, (0, user_utils_1.getUser)(token)];
