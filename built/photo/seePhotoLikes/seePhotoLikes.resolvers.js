...
var seePhotoLikesFn = function (_, _a, _b) {
    var id = _a.id;
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, client.like.findMany({ where: { photoId: id }, select: { user: true } })
                ...
                case 1:
                    ...
                    // const obj = b.map(obj=>obj.user)
                    // console.log(obj)
                    return [2 /*return*/, b.map(function (obj) { return obj.user; })];
            }
        });
    });
};
