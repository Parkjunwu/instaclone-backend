...
var resolver = {
    User: {
        totalFollowing: function (_a, _, _b) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_c) {
                    return [2 /*return*/, client.user.count({
                            where: {
                                followers: {
                                    some: { id: id },
                                },
        ...
        isMe: function (_a, _, _b) {
            ...
            return id === (loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.id);
        },
        //애매해
        ...
        photos: function (_a, _b, _c) {
            var id = _a.id;
            var page = _b.page;
            var client = _c.client, loggedInUser = _c.loggedInUser;
            return client.user.findUnique({ where: { id: id } }).photos(
            //   {
            //   take:10,
            //   skip:10*(page-1)
            // }
