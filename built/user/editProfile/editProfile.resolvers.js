...
var resolverFn = function (_, _a, _b) {
    var firstName = _a.firstName, lastName = _a.lastName, userName = _a.userName, email = _a.email, password = _a.password, bio = _a.bio, avatar = _a.avatar;
    var loggedInUser = _b.loggedInUser, client = _b.client;
    return __awaiter(void 0, void 0, void 0, function () {
        var avatarUrl, uglyPassword, updatedUser;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    avatarUrl = null;
                    if (!avatar) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, shared_utils_1.uploadToS3)(avatar, loggedInUser.id, "avatar")
                ...
                case 3:
                    uglyPassword = _c.sent();
                    _c.label = 4;
                case 4: return [4 /*yield*/, client.user.update({
                        where: {
                            id: loggedInUser.id,
                        },
                ...
                case 5:
                    ...
                    if (updatedUser.id) {
                        ...
                        return [2 /*return*/, { ok: false, error: "can't update profile" }];
                    }
                    return [2 /*return*/];
            }
        });
